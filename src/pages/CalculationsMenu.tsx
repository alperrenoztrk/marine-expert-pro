              ...
              <div className="rounded-xl border border-border/60 bg-background/80 p-3 shadow-inner">
                ...
                <div className="space-y-3">
                  {machineryDetailSections.map((section) => (
                    <details
                      key={section.title}
                      className="group rounded-lg border border-border/50 bg-card/60 p-3 shadow-sm transition hover:border-primary/40"
                    >
                      <summary className="flex cursor-pointer list-none items-start justify-between gap-2 text-left text-foreground">
                        <div className="space-y-1">
