...
import { ArrowLeft, Ship, Anchor, Shield } from "lucide-react";

export default function SpecialShipsMenu() {
  const items = [
    { to: "/special-ships", icon: Ship, label: "Tanker" },
    { to: "/special-ships", icon: Anchor, label: "Ro-Ro" },
    { to: "/special-ships", icon: Shield, label: "Yolcu" },
  ];
