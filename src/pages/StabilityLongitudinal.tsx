      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Calculator className="h-5 w-5" />
              Boyuna Stabilite Hesaplamaları
            </CardTitle>
            <CardDescription>
              Moment alımı, yükleme/tahliye, balast operasyonu ve draft düzeltme
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button 
                    ...
                    onClick={() => calculateLongitudinalMoment()}
                  >
                    Moment Hesapla
                  </Button>
              ...
              <Card className="border-green-200 bg-green-50 dark:bg-green-950">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <Label>Yük Mesafesi (m)</Label>
                    <Input 
                      type="number" 
                      value={loadingDistance} 
                      onChange={(e) => setLoadingDistance(parseFloat(e.target.value) || 0)}
                      placeholder="30"
                    />
                  </div>
                  <Button 
                    className="w-full bg-green-600 hover:bg-green-700"
                    onClick={() => calculateLoadingTrim()}
                  >
                    Trim Hesapla
                  </Button>
                  {loadingWeight > 0 && loadingDistance > 0 && (
                    <div className="p-3 bg-green-100 dark:bg-green-900 rounded-lg">
                      <p className="font-semibold">Sonuç:</p>
                      <p>Trim değişimi: {((loadingWeight * loadingDistance) / 10000).toFixed(3)}m</p>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card className="border-purple-200 bg-purple-50 dark:bg-purple-950">
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label>Balast Ağırlığı (ton)</Label>
                    <Input 
                      type="number" 
                      value={ballastWeight} 
                      onChange={(e) => setBallastWeight(parseFloat(e.target.value) || 0)}
                      placeholder="500"
                    />
                  </div>
                  <div>
                    <Label>Balast Mesafesi (m)</Label>
                    <Input 
                      type="number" 
                      value={ballastDistance} 
                      onChange={(e) => setBallastDistance(parseFloat(e.target.value) || 0)}
                      placeholder="40"
                    />
                  </div>
                  <Button 
                    className="w-full bg-purple-600 hover:bg-purple-700"
                    onClick={() => calculateBallastTrim()}
                  >
                    Trim Hesapla
                  </Button>
                  {ballastWeight > 0 && ballastDistance > 0 && (
                    <div className="p-3 bg-purple-100 dark:bg-purple-900 rounded-lg">
                      <p className="font-semibold">Sonuç:</p>
                      <p>Trim değişimi: {((ballastWeight * ballastDistance) / 10000).toFixed(3)}m</p>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card className="border-orange-200 bg-orange-50 dark:bg-orange-950">
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label>Mevcut Draft (m)</Label>
                    <Input 
                      type="number" 
                      value={currentDraft} 
                      onChange={(e) => setCurrentDraft(parseFloat(e.target.value) || 0)}
                      placeholder="10"
                    />
                  </div>
                  <div>
                    <Label>Hedef Draft (m)</Label>
                    <Input 
                      type="number" 
                      value={targetDraft} 
                      onChange={(e) => setTargetDraft(parseFloat(e.target.value) || 0)}
                      placeholder="9.5"
                    />
                  </div>
                  <Button 
                    className="w-full bg-orange-600 hover:bg-orange-700"
                    onClick={() => correctDrafts()}
                  >
                    Düzeltme Hesapla
                  </Button>
                  {currentDraft > 0 && targetDraft > 0 && (
                    <div className="p-3 bg-orange-100 dark:bg-orange-900 rounded-lg">
                      <p className="font-semibold">Sonuç:</p>
                      <p>Draft farkı: {(currentDraft - targetDraft).toFixed(2)}m</p>
                    </div>
                  )}
                </CardContent>
              </Card>
