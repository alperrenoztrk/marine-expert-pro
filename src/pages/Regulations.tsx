...
const Regulations = () => {
  ...
  const handleDownloadSOLAS = () => {
    ...
    // Add CHAPTER V - SAFETY OF NAVIGATION (Complete chapter)
    addChapter('CHAPTER V - SAFETY OF NAVIGATION', [
      '## INTRODUCTION TO CHAPTER V',
      '',
      'Chapter V applies to all ships on all voyages, except where expressly provided otherwise. This chapter is unique in that it applies to all cargo ships regardless of size and tonnage.',
      '',
      '## PART A - GENERAL',
      '',
      '## Regulation 1 - Application',
      ...
      'Unless expressly provided otherwise, this chapter applies to all ships on all voyages, except:',
      ...
      'Regulations 19, 20, and others specify equipment requirements based on ship size, type, and voyage area.',
      '',
      '#### Radio Equipment',
      'Radio equipment requirements are specified in Chapter IV (Radiocommunications).',
      '',
      '## Regulation 2 - Definitions',
      '',
      ...
      'means a system for automatic exchange of navigation-related information between AIS-fitted ships and between ships and shore-based facilities.',
      '',
      '#### "Bridge navigational watch alarm system (BNWAS)"',
      'means equipment which monitors bridge activity and automatically alerts shore stations when watch-keeping arrangements are inadequate.',
      '',
      '#### "Electronic chart display and information system (ECDIS)"',
      'means a navigation information system which, with adequate back-up arrangements, can be accepted as complying with the up-to-date chart required by regulation V/27.',
      '',
      '#### "Global Maritime Distress and Safety System (GMDSS)"',
      'means the system, as may be amended by the Organization, established to improve the ability of search and rescue services to locate ships, aircraft, and survival craft in distress.',
      '',
      '#### "Gross tonnage"',
      'means the measure of the overall size of a ship determined in accordance with the tonnage measurement regulations contained in annex I of the International Tonnage Convention 1969.',
      '',
      '#### "Search and Rescue services"',
      'means services which search for ships, aircraft, or persons in distress and provide assistance to them.',
      '',
      '### Enhanced Definitions (2024 Updates)',
      '',
      '#### "Recognized mobile satellite service (RMSS)"',
      'includes maritime mobile satellite services meeting IMO performance standards, including services provided by Inmarsat and Iridium Satellite LLC.',
      '',
      '#### "Voyage data recorder (VDR)"',
      'means a system designed to collect, process, encode and store navigational information from various sensors throughout the ship.',
      '',
      '## Regulation 3 - Exemptions and equivalents',
      '',
      '### 3.1 Administration Authority',
      'The Administration may exempt any ship from any of the requirements of this chapter provided that such ship complies with functional requirements equivalent to those specified in this chapter.',
      '',
      '### 3.2 Innovative Technologies',
      'The Administration may allow the installation of alternative arrangements provided they ensure at least the same degree of safety as the prescribed requirements.',
      '',
      '## PART B - MARITIME SERVICES',
      '',
      '## Regulation 4 - Navigational warnings',
      '',
      '### 4.1 Government Responsibility',
      'Each Contracting Government undertakes to ensure that all ships flying its flag are provided with navigational warnings by all appropriate means.',
      '',
      '### 4.2 Information Sources',
      'Navigational warnings should be issued for:',
      '• Defects in aids to navigation',
      '• Presence of wrecks, rocks, or other obstructions',
      '• Military exercises',
      '• Cable or pipeline laying operations',
      '• Any other circumstances affecting navigation',
      '',
      '## Regulation 5 - Meteorological services and warnings',
      '',
      '### 5.1 Weather Information Services',
      'Contracting Governments undertake to encourage ships to collect and report meteorological observations and to arrange for selected ships to make meteorological observations for the benefit of all shipping.',
      '',
      '### 5.2 Weather Routing',
      'The Organization coordinates international weather routing services to provide:',
      '• Route recommendations for optimum weather conditions',
      '• Storm avoidance routing',
      '• Ice routing information',
      '',
      '## Regulation 6 - Ice Patrol Service',
      '',
      '### 6.1 International Ice Patrol',
      'The Government of the United States undertakes to continue the management, operation and financing of the International Ice Patrol and the dissemination of ice information.',
      '',
      '### 6.2 Financial Contributions',
      'The contributions for the support of the Ice Patrol are determined according to the tonnage of each contributing nation passing through ice regions.',
      '',
      '## Regulation 7 - Search and rescue services',
      '',
      '### 7.1 SAR Organization',
      'Each Contracting Government undertakes to ensure that adequate search and rescue services are provided around its coasts.',
      '',
      '### 7.2 International Cooperation',
      'Contracting Governments undertake to develop cooperation with neighboring States to coordinate search and rescue operations.',
      '',
      '### 7.3 SAR Conventions',
      'Search and rescue services are organized in accordance with the International Convention on Maritime Search and Rescue, 1979.',
      '',
      '## Regulation 8 - Life-saving signals',
      '',
      '### 8.1 Signal Recognition',
      'All ships shall ensure that their officers are familiar with life-saving signals as specified in the International Code of Signals.',
      '',
      '### 8.2 Standard Signals',
      'The following signals, when used individually or together, indicate distress and need of assistance:',
      '• A gun or explosive signal every minute',
      '• Continuous sounding of fog signaling apparatus',
      '• Rockets or shells throwing red stars',
      '• SOS signal by any signaling method',
      '• "Mayday" signal by radiotelephone',
      '',
      '## Regulation 9 - Hydrographic services',
      '',
      '### 9.1 Chart Production',
      'Contracting Governments undertake to arrange for the collection and compilation of hydrographic data and the publication of nautical charts.',
      '',
      '### 9.2 International Standards',
      'Nautical charts and publications should conform to international standards developed by the International Hydrographic Organization.',
      '',
      '## PART C - SHIP ROUTEING',
      '',
      '## Regulation 10 - Ships\' routeing',
      '',
      '### 10.1 Traffic Separation Schemes',
      'Ships shall use traffic separation schemes adopted by the Organization when navigating in areas where such schemes have been established.',
      '',
      '### 10.2 Routing Measures',
      'The Organization may adopt routing measures including:',
      ...
      'Ships may be required to report their positions when navigating in areas where ship reporting systems have been established by the Organization.',
      '',
      '### 11.2 Reporting Procedures',
      'Ship reporting should include:',
      '• Ship identification',
      '• Position',
      '• Course and speed',
      '• Time of next reporting',
      '• Any defects affecting navigation',
      '',
      '## Regulation 12 - Vessel traffic services',
      '',
      '### 12.1 VTS Implementation',
      'Vessel traffic services may be established by Contracting Governments where traffic density or degree of risk justifies such services.',
      '',
      '### 12.2 VTS Participation',
      'Ships using areas covered by vessel traffic services should:',
      '• Maintain continuous listening watch on appropriate VHF channels',
      '• Report as required by the VTS authority',
      '• Comply with information, advice, and instructions',
      '',
      '## PART D - NAVIGATIONAL EQUIPMENT AND ARRANGEMENTS',
      '',
      '## Regulation 13 - Establishment and operation of aids to navigation',
      '',
      '### 13.1 Aids to Navigation',
      'Contracting Governments undertake to provide aids to navigation where the volume of traffic justifies such aids.',
      '',
      '### 13.2 International Standards',
      'Aids to navigation should conform to international recommendations and be maintained in efficient working order.',
      '',
      '## Regulation 14 - Ships\' manning',
      '',
      '### 14.1 Safe Manning Requirements',
      'Companies and masters shall ensure that ships are safely manned with qualified personnel in accordance with the safe manning document.',
      '',
      '### 14.2 Watch-keeping Standards',
      'Watch arrangements shall comply with the International Convention on Standards of Training, Certification and Watchkeeping for Seafarers (STCW).',
      '',
      ...
      '',
      '### 15.1 Bridge Design Principles',
      'The design of the bridge shall facilitate safe navigation and provide:',
      '• Adequate all-round visibility',
      '• Optimal equipment arrangement',
      '• Ergonomic working environment',
      '• Integration of navigational systems',
      '',
      '### 15.2 Human Element Considerations',
      'Bridge design should minimize human error by:',
      '• Reducing workload',
      ...
      'Navigational equipment shall be maintained in good working order to ensure continued compliance with performance standards.',
      '',
      '### 16.2 Maintenance Records',
      'Records of maintenance and performance checks shall be maintained on board.',
      '',
      '## Regulation 17 - Electromagnetic compatibility',
      '',
      '### 17.1 EMC Requirements',
      'Electrical and electronic equipment shall be installed to ensure electromagnetic compatibility between systems.',
      '',
      '### 17.2 Installation Standards',
      'Equipment installation shall follow guidelines to prevent electromagnetic interference.',
      '',
      '## Regulation 18 - Approval, surveys and performance standards of navigational systems and equipment and voyage data recorder',
      '',
      '### 18.1 Type Approval',
      'Navigational equipment shall be type approved to ensure compliance with performance standards.',
      '',
      '### 18.2 Survey Requirements',
      'Navigational equipment shall be subject to survey to verify proper installation and operation.',
      '',
      ...
      '',
      '### 19.1 Basic Navigation Equipment',
      'All ships shall carry:',
      '• Magnetic compass',
      '• Gyro compass (ships ≥500 GT)',
      '• Radar (ships ≥300 GT)',
      '• Electronic positioning system',
      '• Speed and distance measuring device',
      '',
      '### 19.2 Enhanced Navigation Equipment',
      'Ships of 500 gross tonnage and upwards shall carry:',
      '• Automatic radar plotting aid (ARPA)',
      '• Electronic chart display and information system (ECDIS)',
      '• Automatic identification system (AIS)',
      '',
      '### 19.3 Communication Equipment',
      'Ships shall carry appropriate radio equipment in accordance with Chapter IV.',
      '',
      '## Regulation 19-1 - Long-range identification and tracking of ships',
      '',
      '### 19-1.1 LRIT Requirements',
      'Ships subject to LRIT requirements shall automatically transmit position information at specified intervals.',
      '',
      '### 19-1.2 System Components',
      'LRIT system includes:',
      '• Shipborne equipment',
      ...
      '',
      '### 20.1 VDR Requirements',
      'Passenger ships and cargo ships of 3,000 gross tonnage and upwards shall be fitted with voyage data recorders.',
      '',
      '### 20.2 Data Recording',
      'VDR shall record:',
      '• Date and time',
      ...
      '',
      '### 21.1 Signal Code',
      'All ships entitled to fly the flag of a Contracting Government shall have on board the International Code of Signals.',
      '',
      '### 21.2 IAMSAR Manual',
      'Ships engaged in search and rescue operations shall have the IAMSAR Manual on board.',
      '',
      '## Regulation 22 - Navigational bridge visibility',
      '',
      '### 22.1 Visibility Requirements',
      'The navigation bridge shall provide adequate visibility in all directions necessary for safe navigation.',
      '',
      '### 22.2 Blind Sectors',
      'The design shall minimize blind sectors and ensure visibility of the water surface from bridge wings.',
      '',
      '## Regulation 23 - Pilot transfer arrangements',
      '',
      '### 23.1 Transfer Equipment',
      'Ships engaged on voyages where pilotage is compulsory shall have proper arrangements for pilot transfer.',
      '',
      '### 23.2 Safety Requirements',
      'Pilot transfer arrangements shall comply with safety standards to ensure safe transfer in various weather conditions.',
      '',
      '## Regulation 24 - Use of heading and/or track control systems',
      '',
      '### 24.1 Autopilot Use',
      'Use of automatic steering shall not relieve the watch officer from navigational duties.',
      '',
      '### 24.2 Manual Override',
      'Manual override of automatic systems shall be immediately available at all times.',
      '',
      '## Regulation 25 - Operation of steering gear',
      '',
      '### 25.1 Steering Requirements',
      'Main steering gear shall be in operation when navigating.',
      '',
      '### 25.2 Backup Systems',
      'Auxiliary steering gear shall be capable of being brought into action within 2 minutes.',
      '',
      '## Regulation 26 - Steering gear: testing and drills',
      '',
      '### 26.1 Pre-departure Tests',
      'Steering gear shall be tested within 12 hours before departure.',
      '',
      '### 26.2 Emergency Drills',
      'Emergency steering drills shall be conducted at least once every three months.',
      '',
      '## Regulation 27 - Nautical charts and nautical publications',
      '',
      '### 27.1 Chart Requirements',
      'Ships shall carry adequate and up-to-date nautical charts and publications for the intended voyage.',
      '',
      '### 27.2 Electronic Charts',
      'ECDIS may be used to meet chart carriage requirements when used with adequate backup arrangements.',
      '',
      '## Regulation 28 - Records of navigational activities and daily reporting',
      '',
      '### 28.1 Navigation Records',
      'A record shall be kept of navigational activities and incidents throughout the voyage.',
      '',
      '### 28.2 Equipment Performance',
      'Daily checks of navigational equipment performance shall be recorded.',
      '',
      '## PART F - DISTRESS SITUATIONS',
      '',
      '## Regulation 29 - Life-saving signals to be used by ships, aircraft or persons in distress',
      '',
      '### 29.1 Standard Distress Signals',
      'The following signals indicate distress and need of assistance:',
      '• Flames from burning tar barrel or oil barrel',
      '• Rocket parachute flares showing red light',
      '• Smoke signals',
      ...
      '',
      '### 30.1 Master\'s Responsibility',
      'The master shall not be constrained by the owner, charterer, or any other person from taking decisions necessary for safe navigation.',
      '',
      '### 30.2 Resource Limitations',
      'Limitations in manning, equipment, or provisions shall not compromise safety of navigation.',
      '',
      '## Regulation 31 - Danger messages',
      '',
      '### 31.1 Obligation to Report',
      'Masters of ships are bound to communicate information about dangers encountered to ships in the vicinity and to competent authorities.',
      '',
      '### 31.2 Types of Dangers',
      'Danger messages should be transmitted for:',
      '• Ice conditions',
      '• Derelicts and other navigational hazards',
      '• Tropical storms',
      ...
      '',
      '### 32.1 Message Format',
      'Danger messages shall contain specific information including position, time, and nature of danger.',
      '',
      '### 32.2 Distribution',
      'Danger messages should be transmitted to all ships in the area and relevant authorities.',
      '',
      '## Regulation 33 - Distress situations: obligations and procedures',
      '',
      '### 33.1 Assistance Obligation',
      'The master of a ship receiving a distress call shall proceed to the assistance of persons in distress.',
      '',
      '### 33.2 SAR Coordination',
      'Masters shall comply with instructions from search and rescue coordination centers.',
      '',
      '## Regulation 34 - Safe navigation and avoidance of dangerous situations',
      '',
      '### 34.1 Prudent Navigation',
      'Ships shall be navigated with prudent regard to prevailing weather, sea conditions, and other circumstances.',
      '',
      '### 34.2 Risk Assessment',
      'Continuous assessment of navigation risks shall be maintained throughout the voyage.',
      '',
      '## Regulation 34-1 - Master\'s discretion',
      '',
      '### 34-1.1 Ultimate Authority',
      'Nothing in this chapter shall interfere with the master\'s authority and discretion in making decisions for safe navigation.',
      '',
      '### 34-1.2 Professional Judgment',
      'The master\'s professional judgment in navigation matters shall take precedence over other considerations.',
      '',
      '## Regulation 35 - Misuse of distress signals',
      '',
      '### 35.1 Prohibition',
      'No person shall use any distress signal except to indicate that a ship, aircraft, or person is in distress.',
      '',
      '### 35.2 Penalties',
      'Contracting Governments shall impose penalties for misuse of distress signals.',
      '',
      '## APPENDIX - RULES FOR THE MANAGEMENT, OPERATION AND FINANCING OF THE NORTH ATLANTIC ICE PATROL',
      '',
      '### International Cooperation',
      'The International Ice Patrol operates under international cooperation to provide ice information services to ships transiting ice-prone areas of the North Atlantic.',
      '',
      '### Service Coverage',
      'The Ice Patrol provides:',
      '• Ice reconnaissance flights',
      '• Ice limit broadcasts',
      '• Ice charts and bulletins',
      '• Route recommendations',
      '',
      '## IMPLEMENTATION NOTES FOR CHAPTER V',
      '',
      '### Universal Application',
      'Remember that Chapter V applies to ALL ships on ALL voyages, making it the most widely applicable SOLAS chapter.',
      '',
      '### Equipment Compliance',
      'Ensure all required navigational equipment is properly maintained and operated according to manufacturer instructions and IMO performance standards.',
      '',
      '### Bridge Procedures',
      'Maintain proper bridge procedures, watch-keeping standards, and navigational record-keeping as required by regulations.',
      '',
      '### Emergency Preparedness',
      'Ensure crews are trained in emergency navigation procedures and distress communication protocols.'
    ]);
