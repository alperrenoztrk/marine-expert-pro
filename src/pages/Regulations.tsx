...
const Regulations = () => {
  ...
  const handleDownloadSOLAS = () => {
    ...
    pdf.setFontSize(18);
    pdf.text('CONSOLIDATED EDITION 2024', pageWidth / 2, 70, { align: 'center' });
    
    pdf.setFontSize(14);
    pdf.setFont('helvetica', 'normal');
    pdf.text('International Convention for the Safety of Life at Sea, 1974', pageWidth / 2, 90, { align: 'center' });
    ...
    addChapter('PART I: ARTICLES OF THE INTERNATIONAL CONVENTION FOR THE SAFETY OF LIFE AT SEA, 1974', [
      ...
      '',
      'A ship which is not normally engaged in the carriage of passengers but which, in special circumstances, is required to carry more than twelve but not more than thirty persons, may be permitted by the Administration to carry such persons without complying with all the requirements of chapter II-1 and chapter III of the present Convention, provided that it complies with the safety provisions which, in the opinion of that Administration, are adequate for this service and are fair and reasonable as between different ships.',
      '',
      '## Article VI - Exemptions',
      '',
      'Any exemption from the provisions of the present Convention may be granted:',
      '(a) by the Administration to ships entitled to fly the flag of its State, provided that such ships do not operate between ports of other Contracting Governments; and',
      '(b) by any Contracting Government to any other ship entering a port under its jurisdiction.',
      '',
      '## Article VII - Force majeure',
      '',
      'A ship not under the present Convention at the time of departure shall not become subject to the provisions of this Convention on account of any deviation from its intended voyage due to stress of weather or any other force majeure.',
      '',
      '## Article VIII - Equivalents',
      '',
      'The Administration may allow any fitting, material, appliance or apparatus to be fitted in a ship as an alternative to that required by the present Convention if such alternative is at least as effective as that required by the Convention.',
      '',
      '## Article IX - Approval of substitutes',
      '',
      'Approvals of substitutes or alternatives provided for in the present Convention shall only be made by the Administration which issues or causes to be issued the relevant certificates.',
      '',
      '## Article X - Repairs, alterations and modifications',
      '',
      'A ship which undergoes repairs, alterations, modifications and outfitting related thereto shall continue to comply with at least the standards previously applicable to the ship under the Convention.',
      '',
      '## Article XI - Zones and areas',
      '',
      'For the purposes of the present Convention, the zones and areas mentioned in the Convention are set out in the Appendix to the Annex.',
      '',
      '## Article XII - Control',
      '',
      '### (a) Inspections and Surveys',
      'Every ship which is subject to control in accordance with the present Convention shall be subject to the inspections and surveys specified in the Convention.',
      '',
      '### (b) Port State Control',
      'A ship when in a port of another Contracting Government is subject to control by officers duly authorized by such Government concerning operational requirements under the present Convention.',
      '',
      '### (c) Intervention Powers',
      'When control is exercised, all possible efforts shall be made to avoid a ship being unduly detained or delayed.',
      '',
      '## Article XIII - Casualties',
      '',
      'Each Contracting Government undertakes to conduct an investigation of any casualty occurring to any of its ships subject to the provisions of the present Convention when it judges that such investigation may assist in determining what changes in the present Convention might be desirable.',
      '',
    ...
    addChapter('ARTICLES OF THE PROTOCOL OF 1988 RELATING TO THE INTERNATIONAL CONVENTION FOR THE SAFETY OF LIFE AT SEA, 1974', [
      ...
      '(a) the Articles of the present Protocol,',
      '(b) the International Convention for the Safety of Life at Sea, 1974 (hereinafter referred to as "the Convention"), subject to the modifications and additions set out in the present Protocol.',
      '',
      '## Article II - Definitions',
      '',
      'For the purposes of the present Protocol:',
      '(a) "Convention" means the International Convention for the Safety of Life at Sea, 1974;',
      '(b) "Organization" means the International Maritime Organization;',
      '(c) "Secretary-General" means the Secretary-General of the Organization.',
      '',
      '## Article III - Application of the Convention',
      '',
      'Articles of the Convention shall apply subject to the modifications and additions set out in the present Protocol.',
      '',
      '## Article IV - Communication of information',
      '',
      'The Parties to the present Protocol undertake to communicate to and deposit with the Secretary-General:',
      '(a) a sufficient number of specimens of their certificates issued under the provisions of the Convention;',
      '(b) the text of the laws, decrees, orders and regulations which shall have been promulgated on the various matters within the scope of the Convention;',
      '(c) a list of nominated surveyors or recognized organizations which are authorized to act on their behalf in the administration of matters relating to the design, construction and equipment of ships carrying dangerous goods in accordance with the provisions of the Convention and the particulars of the specific responsibilities and conditions of the authority delegated to nominated surveyors or recognized organizations.',
      '',
      '## Article V - Signature, ratification, acceptance, approval and accession',
      '',
      '### (a) Signature',
      'The present Protocol shall be open for signature by any State at the Headquarters of the Organization from 1 March 1988 to 28 February 1989.',
      '',
      '### (b) Ratification, acceptance or approval',
      'The present Protocol is subject to ratification, acceptance or approval by States which have signed it.',
      '',
      '### (c) Accession',
      'The present Protocol shall be open for accession by any State after the date on which the Protocol ceases to be open for signature.',
      '',
      '## Article VI - Entry into force',
      '',
      'The present Protocol shall enter into force twelve months after the date on which not less than fifteen States, the combined merchant fleets of which constitute not less than fifty per cent of the gross tonnage of the world\'s merchant fleet, have become Parties to it.',
      '',
