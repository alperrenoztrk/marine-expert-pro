...
export default function StabilityTopicExplanationPage() {
  return (
    <MobileLayout>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <GraduationCap className="h-5 w-5" /> Stabilite Konu Anlatımı
            </CardTitle>
          </CardHeader>
        ...
        <div className="flex justify-end">
          <Button asChild variant="default" className="gap-2">
            <Link to="/stability/formulas">
              <Calculator className="h-4 w-4" /> Formüllere Git
            </Link>
          </Button>
        </div>
