    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background p-4 safe-area-inset">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="max-w-6xl mx-auto">
          <Card className="shadow-lg bg-card/80 border border-border backdrop-blur-sm">
                      ...
                      <div className="space-y-3">
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">Δ = V × ρsw</p>
                            <p><strong>Su çekimi (T):</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">T = V / Awp</p>
                            <p><strong>Ortalama su çekimi:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Tmean = (Tf + 4×Tm + Ta) / 6</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">LCB = ∫ x × A(x) dx / V</p>
                            <p><strong>VCB:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">VCB = ∫ z × A(z) dz / V</p>
                            <p><strong>KB (Dikdörtgen prizma):</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">KB = T / 2</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">TPC = Awp × ρsw / 100</p>
                            <p><strong>MTC:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">MTC = (Δ × GML × B²) / (12 × L)</p>
                            <p><strong>LCF:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">LCF = ∫ x × y(x) dx / Awp</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3">
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">GM = KB + BM - KG</p>
                            <p><strong>KM:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">KM = KB + BM</p>
                            <p><strong>BM (Dikdörtgen prizma):</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">BM = B² / (12 × T)</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">GZ = GM × sin(φ)</p>
                            <p><strong>Büyük açılar (φ {'>'} 15°):</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">GZ = KN - KG × sin(φ)</p>
                            <p><strong>Righting Moment:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Righting Moment = Δ × GZ</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">FSC = ρ × i / (Δ × GM)</p>
                            <p><strong>Tank atalet momenti (i):</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">i = L × B³ / 12</p>
                            <p><strong>Total FSC:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Total FSC = Σ FSCi</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3">
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">Area 0-30° = ∫ GZ dφ (0° to 30°)</p>
                            <p><strong>Area 0-40°:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Area 0-40° = ∫ GZ dφ (0° to 40°)</p>
                            <p><strong>Area 30-40°:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Area 30-40° = ∫ GZ dφ (30° to 40°)</p>
                            <p><strong>Minimum GZ:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Minimum GZ = 0.20 m (φ {'>'} 30°)</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-muted/40 border border-border p-4 rounded-lg">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <p className="font-mono bg-card border border-border p-2 rounded">Wind Heel Angle = arctan(Wind Moment / (Δ × GM))</p>
                            <p><strong>Wind Moment:</strong></p>
                            <p className="font-mono bg-card border border-border p-2 rounded">Wind Moment = 0.5 × ρair × v² × A × h</p>
                          </div>
                        </div>
                      </div>
                    </div>
