...
const SOLASRegulationsPage = () => {
  return (
          <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 from-black to-gray-900 from-slate-900 to-slate-800 p-6">
