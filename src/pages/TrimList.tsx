                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">θ = arctan((T_a - T_f) / L)</p>
                      <p><strong>MCT (Moment to Change Trim):</strong></p>
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">MCT = (Δ × GM_L × B²) / (12 × L)</p>
                      <p><strong>Trim Değişimi:</strong></p>
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">ΔT = (W × d) / MCT</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">TPC = (A_wp × ρ_sw) / 100</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">V = ∫ A(x) dx</p>
                      <p><strong>LCB Hesabı:</strong></p>
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">LCB = ∫ x × A(x) dx / V</p>
                      <p><strong>Moment:</strong></p>
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">M = ∫ x² × A(x) dx</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">V = L × B × h</p>
                      <p><strong>Tank Hacmi (Silindirik):</strong></p>
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">V = π × r² × h</p>
                      <p><strong>Trim Düzeltmesi:</strong></p>
                      <p className="font-mono bg-gray-50 cyberpunk:bg-gray-800 p-1 rounded">ΔV = A × tan(θ) × l</p>
                    </div>
                  </div>
