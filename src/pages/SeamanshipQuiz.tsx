...
import { Anchor, ListChecks, Shuffle } from "lucide-react";
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-6">
        <div className="text-center mb-2 animate-fade-in">
          <div className="inline-flex items-center justify-center p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-2xl mb-4">
            <Anchor className="h-10 w-10 text-emerald-600 dark:text-emerald-400" />
          </div>
          ...
          <p className="text-muted-foreground">Demirleme, palamar, düğüm ve SMS bilginizi ölçün</p>
        </div>
