...
export default function NavigationMenu() {
  ...
  return (
    <div key="navigation-menu-v2" className="relative min-h-screen overflow-hidden bg-white" data-no-translate>
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="mb-6">
          <h1 className="text-5xl font-bold text-blue-600 text-center">Seyir</h1>
        </div>
