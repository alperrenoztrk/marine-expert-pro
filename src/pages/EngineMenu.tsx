...
import { ArrowLeft, Gauge, Fuel, Droplets, Thermometer } from "lucide-react";

export default function EngineMenu() {
  const items = [
    { to: "/engine", icon: Gauge, label: "Güç / Yük" },
    { to: "/engine", icon: Fuel, label: "Yakıt / SFOC" },
    { to: "/engine", icon: Droplets, label: "Soğutma" },
    { to: "/engine", icon: Thermometer, label: "Isı Değiştirici" },
  ];
