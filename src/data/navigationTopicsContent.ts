...
export const navigationTopicsContent: NavigationTopicSection[] = [
    ...
    pages: buildPages("rota-hesaplamalari", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: 1200 NM okyanus geçişi + yüksek enlem kısıtı → Karar: Büyük daireyi WP’lerle bölüp loxodromik bacaklar seç → Çıktı: WP listesi ve bacak kerteriz/mesafe tablosu.",
        ],
    ...
    pages: buildPages("seyir-temelleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: 14 kn hız ve 180 NM kalan mesafe → Karar: D/T/V ile ETA hesapla → Çıktı: 12 saat 51 dk ETA ve rapor güncellemesi.",
        ],
    ...
    pages: buildPages("mercator-loxodromik-seyir", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: 120 NM kıyı geçişi + sabit kerteriz ihtiyacı → Karar: Mercator’da loxodromik rota hesapla → Çıktı: 058°T rota ve 120 NM mesafe.",
        ],
    ...
    pages: buildPages("buyuk-daire-seyri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: 3000 NM okyanus geçişi → Karar: Büyük daire başlangıç/final kerteriz ve ara WP’ler oluştur → Çıktı: WP listesi ve toplam rota mesafesi.",
        ],
    ...
    pages: buildPages("astronomik-navigasyon", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Sextant yüksekliği + kronometre zamanı → Karar: Almanakla LOP hesapla → Çıktı: Kesim noktasında güncellenmiş mevki.",
        ],
    ...
    pages: buildPages("gelgit-hesaplari", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: HW/LW saatleri ve seviye farkı → Karar: Rule of Twelfths ile ara yükseklik hesapla → Çıktı: Geçiş saatinde su yüksekliği.",
        ],
    ...
    pages: buildPages("akinti-ruzgar-duzeltmeleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Set 120°/2 kn ve hız 12 kn → Karar: Akıntı üçgeniyle CTS hesapla → Çıktı: Yeni kerteriz ve SOG.",
        ],
    ...
    pages: buildPages("gelgit-derinlik-emniyeti", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Draft 10.2 m, UKC 1.0 m, gelgit +1.4 m → Karar: Minimum derinlik gereksinimini hesapla → Çıktı: Emniyetli geçiş onayı.",
        ],
    ...
    pages: buildPages("radar-navigasyonu", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Hedef kerteriz 045°/6 NM ve hız 14 kn → Karar: Radar plot ile CPA/TCPA hesapla → Çıktı: CPA 1.2 NM, TCPA 18 dk.",
        ],
    ...
    pages: buildPages("ecdis", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: XTD limiti 0.5 NM → Karar: ECDIS XTD alarm eşiğini ayarla → Çıktı: Sapma olduğunda görsel/işitsel uyarı.",
        ],
  ...
  },
  {
    ...
    pages: buildPages("gps-gnss", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: İki kerteriz ve DR mevki → Karar: Fixing hesapla → Çıktı: Doğrulanmış mevki ve sapma değeri.",
        ],
    ...
    calculationLinks: [
      { title: "Fixing Position (2/3 Kerteriz, Running, Mesafe)", href: "/navigation/calc/fix" },
      { title: "Seyir Hesaplamaları", href: "/navigation" },
    ],
  },
  {
    ...
    pages: buildPages("seyir-emniyeti", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: UKC 0.8 m, squat tahmini 0.4 m → Karar: Emniyet sınırı için hız düşür → Çıktı: UKC 1.2 m hedefi.",
        ],
    ...
    pages: buildPages("insan-faktoru", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Vardiya devrinde çelişkili bilgi → Karar: BRM ile kritik rotayı tekrar doğrula → Çıktı: Ortak karar ve net görev paylaşımı.",
        ],
    ...
    pages: buildPages("kisitli-sularda-seyir", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: UKC 0.9 m + squat 0.3 m → Karar: Hızı düşür ve orta hatta kal → Çıktı: Bank effect azalır, emniyetli UKC korunur.",
        ],
    ...
    pages: buildPages("kiyi-seyri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: İki fener kerterizi → Karar: Kerteriz kesişimiyle fix çıkar → Çıktı: Mevki ve kıyı mesafesi.",
        ],
    ...
    pages: buildPages("harita-isaretleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: IALA A bölgesinde liman girişi → Karar: Kırmızı sancak/yeşil iskele düzenine göre hat çiz → Çıktı: Emniyetli giriş hattı.",
        ],
    ...
    pages: buildPages("pilotaj", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Pilot istasyonu 6 NM, hız 8 kn → Karar: ETA hesaplayıp çağrı saatini belirle → Çıktı: Pilot boarding zamanı netleşir.",
        ],
    ...
    pages: buildPages("seyir-plani-denetimi", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: WP arası 45 NM ve hız 12 kn → Karar: Leg ETA kontrolü yap → Çıktı: Plan/fiili uyum raporu.",
        ],
    ...
    pages: buildPages("agir-hava-seyri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: 6 m dalga, 30 kt rüzgâr → Karar: Safe course ve hız sınırı hesapla → Çıktı: Yeni rota/hız önerisi.",
        ],
    ...
    pages: buildPages("buzlu-sularda-seyir", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Ice chart yoğunluğu 7/10 → Karar: Hızı düşürüp alternatif WP planla → Çıktı: Güvenli rota ve güncel ETA.",
        ],
    ...
    pages: buildPages("manevra-karakteristikleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: 20° dümen, 12 kn → Karar: Turning circle değerlerini hesapla → Çıktı: Advance/transfer ve tactical diameter.",
        ],
    ...
    pages: buildPages("ekonomik-seyir", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Tüketim eğrisi + hedef ETA → Karar: Ekonomik hız hesapla → Çıktı: Önerilen hız ve yakıt planı.",
        ],
    ...
    pages: buildPages("ais-kullanimi", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: AIS hedefi 210°/8 kn, mesafe 5 NM → Karar: CPA/TCPA hesapla → Çıktı: Çarpışma riski seviyesi.",
        ],
    ...
    pages: buildPages("colreg-pratikleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Çapraz durum + CPA 0.5 NM → Karar: Give-way manevrası uygula → Çıktı: CPA 1.5 NM ve güvenli geçiş.",
        ],
    ...
    pages: buildPages("kaza-ornekleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Near-miss raporu + CPA 0.3 NM → Karar: Kök neden analizi yap → Çıktı: Prosedür güncelleme maddeleri.",
        ],
    ...
    pages: buildPages("simulator-modulleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Radar hedefi ve CPA 0.4 NM → Karar: Simülatörde manevra uygula → Çıktı: CPA 1.2 NM ve eğitim notu.",
        ],
    ...
    pages: buildPages("seyir-belgeleri", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Saatlik mevki ve hız kayıtları → Karar: Logbook ve elektronik kaydı eşleştir → Çıktı: Denetime hazır kayıt paketi.",
        ],
    ...
    pages: buildPages("vardiya-yonetimi", [
      {
        ...
        bullets: [
          ...
          "Mini senaryo: Girdi: Yoğun trafik + vardiya değişimi → Karar: Kritik riskleri devir brifingine ekle → Çıktı: Kesintisiz izleme ve ortak durum resmi.",
        ],
