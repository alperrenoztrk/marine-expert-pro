...
// Add challenging USCG-level navigation questions
const challengingNavigationQuestions: QuizQuestion[] = [
  {
    id: 51,
...
export const navigationQuestions: QuizQuestion[] = [
  ...
  // Merge challenging questions
  ...challengingNavigationQuestions
