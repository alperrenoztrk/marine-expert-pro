...
const NavigationWidgets: React.FC = () => {
  ...
  return (
    <div className="space-y-4" data-widget-container>
      ...
      <Card className="glass-widget glass-widget-hover group relative overflow-hidden rounded-2xl p-6 shadow-2xl">
            ...
            <>
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div className="pointer-events-none absolute -inset-6 rounded-full bg-primary/10 blur-3xl opacity-40 transition-opacity duration-500 group-hover:opacity-70" />
                  <div className="pointer-events-none absolute -inset-2 rounded-full bg-gradient-to-br from-amber-200/10 via-transparent to-cyan-300/10 blur-xl opacity-50 transition-opacity duration-500 group-hover:opacity-80" />
                  <MetalCompassDial
                    headingDeg={heading ?? 0}
                    className="relative h-[min(16rem,72vw)] w-[min(16rem,72vw)] max-w-full"
                  />
                </div>
              </div>
