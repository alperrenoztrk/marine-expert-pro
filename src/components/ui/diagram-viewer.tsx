          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <div className="text-center">
                <p className="text-lg font-medium text-gray-700">AI Diyagram Oluşturuluyor...</p>
          ...
          {diagram && !isLoading && (
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm text-gray-500">
                <span>AI destekli diagram - RapidAPI FlowChart Generator</span>
          ...
          {!diagram && !isLoading && !error && (
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Hesaplama verilerinizi analiz ederek AI destekli diyagram oluşturun
                </p>
              </div>
            </div>
          )}
